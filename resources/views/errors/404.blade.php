...
<head>
    ...
    <title>Asset Movies - Page Not Found</title>
...
<body>
    ...
    <div class="message-box">
        <a href="/"><img class="main_logo" src="{{ route('showMainImage', ['filename' => 'logo.webp']) }}" alt="" /></a>
        <h1>404</h1>
        <p>Asset Movies - Page not found. please check page path</p>
